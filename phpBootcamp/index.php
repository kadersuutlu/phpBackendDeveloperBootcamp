<?php 
include_once("yonetim/assets/fonksiyon.php");
$sinif = new yonetim;
?>
...
<a href="<?php echo $sinif->link; ?>" target="_blank" class="linkedin"><i class="fa fa-linkedin"></i></a>
<a href="<?php echo $sinif->git; ?>" target="_blank" class="github"><i class="fa fa-github"></i></a>
<a href="<?php echo $sinif->ints; ?>" target="_blank" class="instagram"><i class="fa fa-instagram"></i></a>
</div>
</div>
</section>
...
<li><a href="#portfolyo">Galeri</a></li>
...
<!--galeri-->
<section id="portfolyo" class="wow fadeInUp">
<div class="container">
